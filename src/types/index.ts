...
export interface LandingPageVersionConfig {
  ...
  pricing_title_style?: string;
  pricing_title_color?: string;
  pricing_subtitle?: string;
  pricing_subtitle_style?: string;
  pricing_subtitle_color?: string;
  price_original?: string;
  price_original_style?: string;
  price_original_color?: string;
  price_promo?: string;
  price_promo_style?: string;
  price_promo_color?: string;
  price_installment?: string;
  price_installment_style?: string;
  price_installment_color?: string;
  pricing_cta_text?: string;
  pricing_cta_style?: string;
  pricing_cta_color?: string;
  pricing_notice?: string;
  pricing_notice_style?: string;
  pricing_notice_color?: string;
