...
app.use('/api', paymentsRouter);           // monta /api/coupons/* e /api/pagarme/* exceto webhook
app.use('/api/pagarme/webhook', webhookRouter);
app.use('/api/cron', cronRouter);
app.use('/api/notifications', notificationsRouter);
app.use('/api', notificationsRouter);      // monta /api/traffic/track
